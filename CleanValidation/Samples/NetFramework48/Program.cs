...
namespace ConsoleSample.NetFramework48
{
    internal static class Program
    {
        private static void Main()
        {
            ...
            // Structured-code segment extraction/sort - a generic replacement for any fixed-width
            // code convention (serial numbers, SKUs, lot codes): here a 10-char code "AAAA-99999"
            // sorted by the 5-digit segment starting at index 5.
            var codes = new System.Collections.Generic.List<string> { "AAAA-00003", "AAAA-00001", "AAAA-00002" };
            ...
            // .NET Framework 4.8 has no string.Replace(string, string, StringComparison) overload.
            Console.WriteLine($"ReplaceIgnoreCase(\"Hello World\", \"WORLD\", \"There\") = {CV.ReplaceIgnoreCase("Hello World", "WORLD", "There")}");

            var flattened = CV.FlattenObjectProperties(new SampleOrder
            {
                Id = 7,
                Customer = new SampleCustomer { Name = "Ada Lovelace", Email = "ada@example.com" }
            });
        ...
        private sealed class SampleCustomer
        {
