...
AppDiagnostics.AppDiagnostics.Logger = loggerFactory.CreateLogger("Sample");

AppDiagnostics.AppDiagnostics.Log(nameof(Program), "Application starting.");
...
catch (Exception ex)
{
    ...
    AppDiagnostics.AppDiagnostics.Log(nameof(Program), ex, isError: true);
}
